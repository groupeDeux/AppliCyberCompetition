 ...
 * @author Gato
 */
@WebServlet(name = "GetListDiscipline", urlPatterns = {"/GetListDiscipline"})
public class GetListDiscipline extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("WEB-INF/disciplines.jsp").forward(request, response);
    }
