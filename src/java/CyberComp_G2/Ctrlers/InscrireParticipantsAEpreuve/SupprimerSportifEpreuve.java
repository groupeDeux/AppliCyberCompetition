 ...
 * @author magourar
 */
@WebServlet(name = "SupprimerSportifEpreuve", urlPatterns = {"/SupprimerSportifEpreuve"})
public class SupprimerSportifEpreuve extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ModifierParticipationsDAO.supprimerSportifUnique(Integer.parseInt(idEpreuve), Integer.parseInt(idParticipant));
