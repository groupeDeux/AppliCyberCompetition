            ...
            <div class="col-xs-10 col-xs-offset-1">
               ...
               Affichage du titre panier
                ...
                <div class="rowPanierBarre" style="font-weight:bold">
                    <div class="row">
                        <br> 
                        <div class="col-xs-12"><h3>Votre panier contient <% if(lesEpreuvesDuPanier.size()==0){out.print("est vide !"); }else{ out.println(lesEpreuvesDuPanier.size() + " élément(s)");} %></h3></div>
                    </div> 
                    <br>
                </div> 
               ...
               Zone du tableau détaillant les achats
                ...
                <div class="rowPanier">  
                    <div class="row ">
                        <div class="col-xs-3  bordureDroite"><br><%= epreuve.getNomEpreuve()%></div>
                        <div class="col-xs-2  bordureDroite"><br><%= epreuve.getTarif()%></div>
                        ...
                        <div class="col-xs-2  bordureDroite"><br><%= montantEpreuve%> €</div>
                        <div class="col-xs-2">
                            <br>
              ...
              Zone du tableau détaillant les achats N2
                ...
                <div class="rowPanier">  
                    <div class="row ">
                        <div class="col-xs-3  bordureDroite"><br>${nomEpreuve}</div>
                ...
                <div class="rowPanier">
                    <div class="row">
                        ...
                        <div class="col-xs-4"><%= montantTotal%></div>
